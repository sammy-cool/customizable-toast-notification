 ...
 * @param {Function} onClose - Close callback
 */
export function createBasicToast(toast: HTMLElement, options: any, onClose: Function): void;
/**
 * Emergency toast as last resort
 * @param {Object} options - Toast options
 * @param {Function} onClose - Close callback
 */
export function createEmergencyToast(options: any, onClose: Function): HTMLDivElement;
